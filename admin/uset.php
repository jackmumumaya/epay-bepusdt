...
if($conf['transfer_usdt'])$settle_select.='<option value="5">USDT/USDC</option>';
...
foreach($usdt_chains as $key => $value){
    $usdt_chain_select .= '<option value="'.$key.'">'.$value.'</option>';
}
...
<div class="form-group">
<label>USDT结算链路:</label><br><select class="form-control" name="usdt_chain"><option value="">不使用USDT结算</option><?php echo $usdt_chain_select?></select>
</div>
<div class="form-group">
<label>结算账号:</label><br>
...
<div class="form-group">
<label>USDT结算链路:</label><br><select class="form-control" name="usdt_chain" default="<?php echo $row['usdt_chain']??''?>"><option value="">不使用USDT结算</option><?php echo $usdt_chain_select?></select>
</div>
<div class="form-group">
<label>结算账号:</label><br>
